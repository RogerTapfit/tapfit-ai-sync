                ...
                {slot.image ? (
                  ...
                  <div className="w-full h-80 md:h-96 rounded-lg bg-muted/30 flex items-center justify-center overflow-hidden">
                    {slot.key === 'front' ? (
                      ...
                      <img
                        src="/lovable-uploads/d5c04fea-07df-4c14-a7b0-ceeda6da7354.png"
                        alt="Body scan back placeholder silhouette"
                        className="max-h-full max-w-full object-contain opacity-90"
                        loading="lazy"
                      />
                    ) : slot.key === 'right' ? (
                      <img
                        src="/lovable-uploads/fad567ba-18d1-41d4-83d8-265b76c50fb7.png"
                        alt="Body scan right placeholder silhouette"
                        className="max-h-full max-w-full object-contain opacity-90"
                        loading="lazy"
                      />
                    ) : (
