// Audio recording utilities for realtime voice chat
...
class AudioQueue {
  ...
  private createWavFromPCM(pcmData: Uint8Array): ArrayBuffer {
    ...
    const wavUint8 = new Uint8Array(wavArray);
    wavUint8.set(new Uint8Array(wavHeader), 0);
    wavUint8.set(new Uint8Array(int16Data.buffer), wavHeader.byteLength);
