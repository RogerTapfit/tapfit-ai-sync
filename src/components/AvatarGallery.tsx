                ...
                return (
                  ...
                  >
                    ...
                    <img
                      ...
                      className={`w-full h-40 object-contain transition-transform duration-200 ease-out will-change-transform group-hover:scale-[1.05] ${a.name === 'Nova Hawk' ? 'object-left' : 'object-center'} ${a.name === 'Reptile' ? 'scale-[1.2]' : ''}`}
                    />
