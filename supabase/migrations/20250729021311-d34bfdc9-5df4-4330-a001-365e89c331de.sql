-- Fix the primary_goal constraint to match frontend values exactly
...
CHECK (primary_goal IN ('muscle_building', 'fat_loss', 'toning', 'endurance', 'general_fitness', 'strength_training', 'athletic_performance'));
