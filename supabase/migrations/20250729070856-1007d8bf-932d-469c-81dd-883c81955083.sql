-- Fix profile creation and calibration issues - corrected version
...
BEGIN
  ...
  FOR user_record IN 
    SELECT id, weight_kg, height_cm, gender 
    FROM public.profiles 
    WHERE onboarding_completed = true 
      AND calibration_completed = false
      AND weight_kg IS NOT NULL
  LOOP
    -- Calculate nutrition goals for this user
    ...
    -- Update the profile with calculated goals
