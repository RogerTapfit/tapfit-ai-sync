...
-- First, let's add some realistic gym machine exercises for different muscle groups
...
CROSS JOIN (
  VALUES
    ...
    ('Stair Climber', 'cardio', 1, NULL, 0, 4)
) AS exercise_data(machine_name, exercise_type, sets, reps, rest_seconds, exercise_order)
WHERE sw.target_muscle_group = 'glutes_conditioning';

-- Update the stair climber with duration instead of reps
UPDATE workout_exercises 
SET duration_minutes = 15, reps = NULL
WHERE machine_name = 'Stair Climber' AND exercise_type = 'cardio';